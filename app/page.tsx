...
export default function Home(){
  ...
  return(
    <div className="bg-black text-white min-h-screen pb-32">
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Inter:wght@500;700;800&display=swap'); *{font-family:'Inter',sans-serif!important}`}</style>

      {/* FIXED NAV - LOGO LEFT / CART RIGHT */}
      <nav className="flex justify-between items-center px-5 h-[62px] sticky top-0 bg-black z-40 border-b border-zinc-900">
        <div className="flex items-center gap-3">
          <div className="w-[38px] h-[38px] rounded-xl bg-[#111] border border-zinc-800 flex items-center justify-center">
            <span className="font-black text-[19px] text-[#D4AF37]">K</span>
          </div>
          <h1 className="font-black text-[15px] tracking-[0.18em] text-[#D4AF37] leading-[14px]">KAIHA<br/>65</h1>
        </div>
        <div className="flex items-center gap-[18px]">
          <button onClick={()=>setShowBell(true)} className="w-[22px] h-[22px] flex items-center justify-center"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.6"><path d="M6 8a6 6 0 0 1 12 0c0 7 6 5 6 10H0c0-5 6-3 6-10"/><path d="M10 20a2 2 0 0 0 4 0"/></svg></button>
          <button onClick={()=>setShowWishlist(true)} className="w-[22px] h-[22px] flex items-center justify-center"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.6"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l8.2-7.6 1-1a5.5 5.5 0 0 0 0-7.8z"/></svg></button>
          <button onClick={()=>setShowProfile(true)} className="w-[22px] h-[22px] flex items-center justify-center"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.6"><circle cx="12" cy="8" r="3.5"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg></button>
          <button onClick={()=>setShowCart(true)} className="w-[22px] h-[22px] flex items-center justify-center relative"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.6"><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.5 3h2l2.5 12h13l2-8H6.5"/></svg>{cartItems.length>0 && <span className="absolute -top-2 -right-2 bg-yellow-500 text-black text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center">{cartItems.reduce((a,b)=>a+b.qty,0)}</span>}</button>
        </div>
      </nav>
