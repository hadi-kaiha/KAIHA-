...
{/* HEADER K BADA 72px */}
<div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"12px 18px",borderBottom:"1px solid #1a1a1a"}}>
<div onClick={()=>setPg("home")} style={{display:"flex",alignItems:"center",gap:"12px",cursor:"pointer"}}>
<img src={LOGO} alt="K" style={{height:"72px",width:"72px",objectFit:"contain",borderRadius:"12px"}}/>
...
<div style={{display:"flex",justifyContent:"space-between"}}><b style={{fontSize:"14px"}}>Shop by Style</b><span onClick={()=>setPg("all")} style={{color:"#D4B78F",fontSize:"11px",cursor:"pointer"}}>See all ›</span></div>
<div style={{display:"flex",gap:"10px",marginTop:"10px",overflowX:"auto"}}>
{[P[2],P[3],P[4],P[5],P[1]].map((s:any,i:number)=>(
...
{mn && <div style={{position:"fixed",inset:0,zIndex:99,display:"flex",justifyContent:"flex-end"}}><div style={{position:"absolute",inset:0,background:"rgba(0,0,0,0.8)"}} onClick={()=>setMn(false)}></div><div style={{position:"relative",width:"78%",background:"#0a0a0a",height:"100%",padding:"18px",borderLeft:"1px solid #D4B78F66"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><div style={{display:"flex",alignItems:"center",gap:"8px"}}><img src={LOGO} style={{height:"48px"}} alt=""/><span style={{color:"#D4B78F",letterSpacing:"0.35em",fontSize:"13px"}}>KAIHA</span></div><button onClick={()=>setMn(false)} style={{width:"30px",height:"30px",border:"1px solid #D4B78F",borderRadius:"999px",background:"none",color:"#D4B78F"}}>✕</button></div><div style={{marginTop:"18px",display:"grid",gap:"6px"}}>{[{l:"Home",v:"home"},{l:"Shop - Shops & Items",v:"shop"},{l:"Reels - KAIHA TV",v:"reels"},{l:"Bag - Cart",v:"bag"},{l:"Profile",v:"profile"},{l:"All Items",v:"all"}].map(it=><div key={it.l} onClick={()=>{setPg(it.v);setMn(false);}} style={{padding:"12px",borderRadius:"8px",background:pg===it.v?"#1a1a1a":"transparent",border:"1px solid #222",color:pg===it.v?"#D4B78F":"#ccc",fontSize:"13px",cursor:"pointer"}}>{it.l}</div>)}</div></div></div>}
