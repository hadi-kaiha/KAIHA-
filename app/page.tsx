...
<span key={pg} className={pg==="home"?"kaihaOnce":""} style={{color:"#D4B78F",letterSpacing:"0.38em",fontSize:"19px",fontFamily:"'Montserrat', 'Inter', sans-serif",fontWeight:"400",textTransform:"uppercase",display:"inline-block",whiteSpace:"nowrap"}}>KAIHA</span>
</div>
...
{/* FOOTER ONLY - © KAIHA - HADI SUKKUR 2026 */}
<div style={{textAlign:"center",padding:"24px 0 10px",borderTop:"1px solid #1a1a1a",marginTop:"24px"}}>
<div style={{color:"#D4B78F",fontSize:"10px",letterSpacing:"0.32em",fontFamily:"'Montserrat', sans-serif",fontWeight:"400"}}>KAIHA</div>
...
<div style={{color:"#3a3a3a",fontSize:"7px",letterSpacing:"0.15em",marginTop:"3px"}}>LUXURY FROM SUKKUR • PAKISTAN</div>
</div>
